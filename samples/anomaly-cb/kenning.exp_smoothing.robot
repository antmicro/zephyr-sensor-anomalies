...
Should Display Sensors Test
    ...
    Wait For Line on UART    Anomaly detected with probability 0.54517
    Wait For Line on UART    Anomaly detected with probability 0.56713
    Wait For Line on UART    Anomaly detected with probability 0.59238
    Wait For Line on UART    Anomaly detected with probability 0.59027
