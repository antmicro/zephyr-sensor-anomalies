...
project = "Zephyr Sensor Anomalies"
basic_filename = "zephyr-sensor-anomalies"
authors = "Antmicro"
...
extensions = default_extensions + ["sphinx.ext.todo", "breathe"]
...
breathe_projects = {
    "zephyr_sensor_anomalies": "../xml",
}

breathe_default_project = "zephyr_sensor_anomalies"
